...
const DetalhesUsuario = lazy(() => import("./pages/Detalhes/user/DetalhesUsuario"));
...
export const appRoutes = [
  ...
  { path: "/usuarios/detalhes/:userId", element: <RoleBasedRoute requiredRole={ROLES.DRIVER}><AnimatedPage><DetalhesUsuario /></AnimatedPage></RoleBasedRoute>, label: "Detalhes do Usuário" },
