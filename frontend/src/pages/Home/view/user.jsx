      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-blue-500">{dashboardData.stats.pendentes}</p>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-green-500">{dashboardData.stats.concluidas}</p>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-purple-500">{dashboardData.stats.total}</p>
                  </div>
          ...
          >
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Você tem <strong className="text-primary">{dashboardData.stats.pendentes}</strong> {dashboardData.stats.pendentes === 1 ? 'viagem pendente' : 'viagens pendentes'}
              </p>
            </CardContent>
          </Card>
            </div>
            ...
            {dashboardData.proximasViagens.length === 0 ? (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge variant={
                    viagem.status === 'confirmada' ? 'default' :
                    viagem.status === 'pendente' ? 'secondary' :
                    viagem.status === 'finalizada' ? 'outline' : 'secondary'
                  }>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">{viagem.origem}</p>
                    </div>
                  </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Lembre-se de agendar suas viagens com pelo menos 1 dia útil de antecedência.
                Em caso de emergência, entre em contato diretamente com nossa central.
              </p>
            </div>
          </div>
        </CardContent>
